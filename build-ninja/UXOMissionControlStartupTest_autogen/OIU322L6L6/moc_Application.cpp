...
QT_MOC_LITERAL(3, 25, 13), // "errorOccurred"
QT_MOC_LITERAL(4, 39, 7), // "message"
QT_MOC_LITERAL(5, 47, 14) // "showMainWindow"

    },
    "Application\0initialized\0\0errorOccurred\0"
    "message\0showMainWindow"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Application::initialized)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Application::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Application::errorOccurred(const QString & _t1)
{
