...
> **注**：CURRENT 编译目标中不含 `RightPanelWidget`、`AlertPanel`、`DetectionControlPanel`、`BatchOperationBar`、`SituationView`、`DeviceStatusPanel`、`DecisionSuggestionPanel`（源文件存在但未纳入 CMakeLists）；§4.3/§4.4 中相关行描述的是历史规划状态，不代表当前编译产物。
