...
| ARC-006 | 需求来源 | `docs/dev/incremental-prd-uxo-recognition-and-mos.md` | [`requirements/incremental-prd-uxo-recognition-and-mos.md`](requirements/incremental-prd-uxo-recognition-and-mos.md) | 2026-07-30 | 合并需求已拆分为独立 UXR/MOS Draft，旧合并版本不再作为 active 输入 | `prd-uxr.md`、`prd-mos.md`、`PRODUCT.md` | Git rename，字节不变 |
